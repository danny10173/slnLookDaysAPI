    ...
    public class WeatherController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetWeatherData()
        {
            try
            {
                ...
                var response = await httpClient.GetAsync("https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-D0047-091?Authorization=CWA-32C13655-5D9F-4048-8E35-69C9F9029E1D");
